...
export type EmptyMediaProps = ComponentProps<"span"> & VariantProps<typeof emptyStateMediaVariants>;

export function EmptyMedia({ className, tone, ...props }: EmptyMediaProps) {
  return (
    <span
...
export function EmptyHeader({ className, ...props }: ComponentProps<"div">) {
  return <div className={cn("min-w-0", className)} data-slot="empty-header" {...props} />;
}
