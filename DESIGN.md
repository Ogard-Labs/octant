...
is the peek, the back card fills that box a step below the prompt in dark
and the same white sheet in light, and the front card sits narrower so two
rounded rectangles read, not a footer.
