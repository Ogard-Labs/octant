...
conversation behind the user's back ([0151](decisions/0151-native-resume-keeps-a-durable-identity.md)). A separate replay checkpoint imports existing Code reports on
