...
[decisions/0079-hand-off-writes-a-canvas-from-the-export-cut.md](decisions/0079-hand-off-writes-a-canvas-from-the-export-cut.md)). The dock follows the active
