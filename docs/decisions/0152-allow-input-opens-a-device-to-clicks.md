...
- This record supersedes exactly one rule of 0142: that the first tap, typed
  ...
  Full access / Plan rules in 0142 stand. It supersedes 0151's rule that the
...
- Closing the pane still does not shut the destination down (0151).
...
- 0151 The agent opens the in-app Simulator pane (first-input confirmation superseded)
