...
**Design:** [`../decisions/0061-agent-to-agent-messaging.md`](../decisions/0061-agent-to-agent-messaging.md)
...
- This document is design-only. Controls are not enforced until contracts,
  domain policy, and server delivery land under an Accepted 0061.
